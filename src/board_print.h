...
chessboard[whiteKnight1.horizontal][whiteKnight1.vertical] = whiteKnight1.name;
Knight whiteKnight2 = {6, 0, 'N'};
chessboard[whiteKnight2.horizontal][whiteKnight2.vertical] = whiteKnight2.name;
Knight blackKnight1 = {1, 7, 'n'};
chessboard[blackKnight1.horizontal][blackKnight1.vertical] = blackKnight1.name;
Knight blackKnight2 = {6, 7, 'n'};
chessboard[blackKnight2.horizontal][blackKnight2.vertical] = blackKnight2.name;
...
chessboard[whiteBishop1.horizontal][whiteBishop1.vertical] = whiteBishop1.name;
Bishop whiteBishop2 = {5, 0, 'B'};
chessboard[whiteBishop2.horizontal][whiteBishop2.vertical] = whiteBishop2.name;
Bishop blackBishop1 = {2, 7, 'b'};
chessboard[blackBishop1.horizontal][blackBishop1.vertical] = blackBishop1.name;
Bishop blackBishop2 = {5, 7, 'b'};
chessboard[blackBishop2.horizontal][blackBishop2.vertical] = blackBishop2.name;
